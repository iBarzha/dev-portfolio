          ...
          <div className="p-6">
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-600 dark:text-slate-400">Forks</span>
                        </div>
                        <span className="text-sm font-medium text-slate-900 dark:text-white">
                          {gitStats.forks || 0}
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-600 dark:text-slate-400">Watchers</span>
                        </div>
                        <span className="text-sm font-medium text-slate-900 dark:text-white">
                          {gitStats.watchers || 0}
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-600 dark:text-slate-400">Last Commit</span>
                        </div>
                        <span className="text-sm font-medium text-slate-900 dark:text-white">
                          {formatDate(gitStats.last_commit || gitStats.updated_at)}
                        </span>
                      </div>
                      {gitStats.open_issues > 0 && (
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <GitCommit size={16} className="text-red-500" />
                            <span className="text-sm text-slate-600 dark:text-slate-400">Open Issues</span>
                          </div>
                          <span className="text-sm font-medium text-slate-900 dark:text-white">
                            {gitStats.open_issues}
                          </span>
                        </div>
                      )}
                    </div>
                ...
                {/* GitHub Topics */}
                {gitStats?.topics && gitStats.topics.length > 0 && (
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-4">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">
                      Topics
                    </h3>
                    <div className="flex flex-wrap gap-2">
                      {gitStats.topics.map((topic, index) => (
                        <span
                          key={index}
                          className="bg-cyan-100 dark:bg-cyan-900/30 text-cyan-800 dark:text-cyan-400 px-2 py-1 rounded text-xs font-medium"
                        >
                          {topic}
                        </span>
                      ))}
      ...
      <section id="projects" className="py-20 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-4">Loading projects...</p>
          </div>
        </div>
      </section>
    );
